...
@section('content')
    <div class="min-h-screen flex items-center justify-center">
        <form class="bg-[#E7C4C4] shadow-md rounded px-8 pt-6 pb-8 mb-4 w-full max-w-sm max-sm:bg-white" method="POST"
                    ...
                    <div class="p-3 space-y-2">
                        ...
                        <ul>
                            ...
                            <li class="flex items-center">
                                ...
                                Kata sandi yang lebih panjang (minimal 12 karakter)
                            </li>
                        </ul>
                    </div>
            ...
            <div class="mb-4 flex items-center">
                <i class="fas fa-lock text-white leading-tight rounded-l-md bg-[#B76A6A] p-[9px]"></i>
                <input
                    class="shadow appearance-none border rounded-r-md w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:border-[#B76A6A] focus:ring-[#B76A6A]"
            ...
            <div class="mb-4 flex items-center">
                <i class="fas fa-pen text-white leading-tight rounded-l-md bg-[#B76A6A] p-[9px]"></i>
                <select
                    class="shadow appearance-none border rounded-r-md w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:border-[#B76A6A] focus:ring-[#B76A6A]"
                    id="status" name="status" required>
                    <option value="" disabled selected>Pilih Status</option>
                    <option value="Guru" class="hover:bg-customBlue">Guru</option>
                    <option value="Murid" class="hover:bg-customBlue">Siswa/Siswi</option>
                    <option value="Lainnya" class="hover:bg-customBlue">Lainnya</option>
                </select>
            </div>
